"""
settings_dialog_window.py - نافذة إعدادات المشروع
"""
...
class SettingsDialog(QDialog):
    ...
    def load_settings(self):
        """
        تحميل الإعدادات من ملف JSON أو تعيين القيم الافتراضية.
        """
        default_data = {
    ...
    def save_settings(self):
        """
        حفظ الإعدادات في ملف JSON بعد التحقق من صحة البيانات.
        """
